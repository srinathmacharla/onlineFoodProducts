    ...
    <div className='p-3 md:p-4'>
        <div className='w-full max-w-sm bg-white m-auto flex items-center flex-col p-4'>
            ...
            <form className="w-full py-3 flex flex-col" onSubmit={handleSubmit}>
                ...
                <input type={"text"} id='firstNmae' name='firstName' className="mt-1 mb-2 w-full bg-slate-200 px-2 py-1 rounded focus-within:outline-blue-300" value={data.firstName} onChange={handleOnChange} ></input>
