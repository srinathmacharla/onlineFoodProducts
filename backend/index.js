...
// payment gat way
// console.log(process.env.STRIPE_SCRETE_KEY)
...
//         shipping_options : [{shipping_rate : "shr_1ObJXoSH5w4NMj0EQMEMWuzL"}],
...
app.post('/order', async (req, res) => {
  ...
  try {
    console.log(process.env.RAZORPAY_KEY_ID, "RAZORPAY_KEY_ID");
